...
//        print("Collecting Compilation Units....");
    ...
    static List<APIElement> parseSourceCode(CompileUnit compileUnit)
    {
        ...
        cu.accept(new ASTVisitor() {
            //Visit every import declaration (written by Linghao)
            @Override
            public boolean visit(ImportDeclaration impDecNode) {
                Name impDeclaration = impDecNode.getName();
                //System.out.println("1   "+ impDeclaration);
                importDeclarations.add(impDeclaration.toString());
                return true;
            }
                    ...
                    block.accept(new ASTVisitor() {
                        ...
                        public boolean visit(VariableDeclarationFragment varDecNode) {
                            ...
                            if (variableBinding != null && !variableBinding.getType().isFromSource()) {
                                ...
                                if(actualFQN == null || importDeclarations.contains(actualFQN))
                                    return true;
